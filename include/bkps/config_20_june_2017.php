...
if('m.brsoftech.net' == $_SERVER['HTTP_HOST'] || strpos($_SERVER['HTTP_HOST'], 'pida') !== false){
...
define('DRIVER_PICKED_REQUEST_MSG', 'Driver has picked up from ');
define('DRIVER_PICKED_REQUEST_MSG_ES', 'El conductor ha recogido de ');

define('REACHED_DRIVER_MSG', 'Driver is on the way to the ');
define('REACHED_DRIVER_MSG_ES', 'El conductor est en camino hacia el ');

define('DRIVER_DROP_OFF_MSG', 'Driver has drop off to ');
define('DRIVER_DROP_OFF_MSG_ES', 'El conductor ha bajado a ');
...
define('CREDIT_CARD_CHARGED_MSG', 'Your credit card has been charged for amount of {price} for booking');
