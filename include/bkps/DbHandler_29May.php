...
//								return true;	
	...
	if ($pushNotiyType == BOOKING_REQUEST_DRIVER) {
		...
		if ($pdata['device_type'] == 'I') {
			...
			$iphonePushData['push_msg'] = getMessage($lang_code, "NEW_BOOKING_REQUEST");
		    ...
		    $andriodPushData['push_msg'] = getMessage($lang_code, "NEW_BOOKING_REQUEST");
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = getMessage($lang_code, "DRIVER_ACCEPT_BOOKING_REQUEST");
		    ...
		    $andriodPushData = array();
		    $andriodPushData = $pdata;
		    $andriodPushData['push_msg'] = getMessage($lang_code, "DRIVER_ACCEPT_BOOKING_REQUEST");
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = getMessage($lang_code, "DRIVER_PICKED_REQUEST").$sourceAddress;
		    ...
		    $andriodPushData = $pdata;
		    $sourceAddress = $pdata['source_address'];
		    $andriodPushData['push_msg'] = getMessage($lang_code, "DRIVER_PICKED_REQUEST").$sourceAddress;
		...
		if ($pdata['device_type'] == 'I') { 
			...
			$iphonePushData['push_msg'] = getMessage($lang_code, "DRIVER_DROP_OFF").$destinationAddress;
		    ...
		    $andriodPushData = $pdata;
		    $destinationAddress = $pdata['destination_address'];
		    $andriodPushData['push_msg'] = getMessage($lang_code, "DRIVER_DROP_OFF").$destinationAddress;
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = getMessage($lang_code, "NO_DRIVER_AVAILABLE");
		    ...
		    $andriodPushData = array();
		    $andriodPushData = $pdata;
		    $andriodPushData['push_msg'] = getMessage($lang_code, "NO_DRIVER_AVAILABLE");
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = str_replace('{price}', $price, getMessage($lang_code, "CREDIT_CARD_CHARGED"));
		    ...
		    $andriodPushData['push_msg'] = str_replace('{price}', $price, getMessage($lang_code, "CREDIT_CARD_CHARGED"));
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = str_replace('{price}', $price, getMessage($lang_code, "AMOUNT_RECEIVED"));
		    ...
		    $andriodPushData = $pdata;
		    $price = $pdata['price'];
		    $andriodPushData['push_msg'] = str_replace('{price}', $price, getMessage($lang_code, "AMOUNT_RECEIVED"));
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = getMessage($lang_code, "USER_CANCEL_BOOKING");
		    ...
		    $andriodPushData = array();
		    $andriodPushData = $pdata;
		    $andriodPushData['push_msg'] = getMessage($lang_code, "USER_CANCEL_BOOKING");
		...
		if ($pdata['device_type'] == 'I') { 
		    ...
		    $iphonePushData['push_msg'] = getMessage($lang_code, "LOGIN_OTHER_DEVICE");
		    ...
		    $andriodPushData = array();
		    $andriodPushData = $pdata;
		    $andriodPushData['push_msg'] = getMessage($lang_code, "LOGIN_OTHER_DEVICE");
...
//	    $message['title'] = $message['push_msg'];
	...
	$id = $params['id'];
	$query = "SELECT
					  brt.id,brt.booking_id,b.price,b.pickup_lat,b.pickup_long,b.total_miles,b.price,b.dimension,b.cubicfeet,IFNULL(b.cargo_type_notes,'') cargo_type_notes,IFNULL(b.delivery_type_notes,'') delivery_type_notes, u.first_name,u.last_name,u.photo,u.phone,d.device_type,d.device_type,d.device_token,IFNULL(d.lang_code, '".DEFAULT_LANGUAGE."') lang_code
					FROM
...
//	    $riderEmail = 'jspanwarbwr@gmail.com';
    ...
    public function getCurrentTripDetails($user_id, $lang){
    	$select_booking = "SELECT * from bookings where (user_id = $user_id or driver_id = $user_id) and booking_status IN('1','2') order by id desc LIMIT 1";
    	...
    	if(!empty($select_booking)){
			...
			$query = "SELECT
				    b.id,b.pickup_date,IFNULL(d.id,'') driver_id,IFNULL(vt.image) vehicle_type_image,IFNULL(d.first_name,'') d.first_name,IFNULL('d.last_name','') d.last_name,IFNULL(d.phone,'') d.phone,IFNULL(d.photo,'') d.photo,IFNULL(u.device_type,'') u.device_type,IFNULL(u.device_token,'') u.device_token,IFNULL(vtl.name,'') vtl.name,IFNULL(v.plate_no) v.plate_no
				  FROM
				    bookings AS b
				    LEFT JOIN users AS u
				      ON b.user_id = u.id
	...
	if (!empty($select_booking)) {
	    ...
	    $query = "SELECT brt.id,brt.booking_id,b.price,b.pickup_lat,b.pickup_long,b.total_miles,b.price,b.dimension,b.cubicfeet,u.first_name,u.last_name,u.photo,u.phone,d.device_type,d.device_type,d.device_token,IFNULL(d.lang_code, '" . $langCode . "') lang_code
					FROM
					  booking_request_temps AS brt
					  LEFT JOIN users AS u
					    ON brt.user_id = u.id
