...
define('BOOKING_CANCEL_TIME_ERROR_MSG', 'Booking cannot be cancelled because 5 minutes have been past from booking time');
define('BOOKING_CANCEL_TIME_ERROR_MSG_ES', 'No se puede cancelar la reserva porque han pasado 5 minutos desde el momento de la reserva.');
...
define('PAYMENT_DEDUCT_MSG', 'Payment has been captured');
define('PAYMENT_DEDUCT_MSG_ES', 'Reservacion se ha completado');
...
//phpmailer settings
defined('SMTP_SERVER') or define('SMTP_SERVER', 'mail.pida.com');
defined('SMTP_USERNAME') or define('SMTP_USERNAME', 'admin@pida.com');
defined('SMTP_PASSWORD') or define('SMTP_PASSWORD', "c0]GZ9!jg;81");
...
//Customer Docs
define('CUSTOMER_DOC_PATH', APIPATH . 'app/webroot/uploads/customer_documents/');
//Driver Docs
...
define('CRON_JOB_DURATION_AUTO_LOGOUT_DRIVER', 3); 
define('BOOKING_CANCEL_MINUTE', 5); 
define('BOOKING_SCHEDULE_CANCEL_MINUTE', 15); 
...
define('ANDRIOD_PUSH_KEY', 'AIzaSyANYmsfEfFlhm3IYlK15sx7nmvC3NYm4pE');
define('IPHONE_PASS_PHRASE', '123456');
//old pem file
//define('IPHONE_PEM_FILE', 'pushcert.pem');
define('IPHONE_PEM_FILE', 'apns-pro.pem');
...
define("STRIPE_AUTOLOAD", APIPATH."lib/stripe/vendor/autoload.php");
  define("STRIPE_PUBLISHABLE_KEY", "pk_live_HfAbB3oM0jRwIIv5iviepPH9");
 define("STRIPE_SECRET_KEY", "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");
 define("STRIPE_CLIENT_ID", "acct_1CBZqMALaHqWUcta"); 

//define("STRIPE_PUBLISHABLE_KEY", "pk_test_19fEUUi0oF4Ovxk5IgLacLiy");
//define("STRIPE_SECRET_KEY", "sk_test_FXxDOsRJJnVr3u8KyxPJZKki");
//define("STRIPE_CLIENT_ID", "ca_CsQs8Pc9c5zdWrZZHP94LJ3SQQ9RJNm8"); 

################## Google Api CREDENTIALS  ###################
define("GOOGLE_API_KEY", "AIzaSyDEHe87jnqea9sCaKftcPcWCJFOYo4WW1U"); 
