...
$doc_status = serialize(array('A' => 'Approved', 'P' => 'Pending', 'R' => 'Rejected'));
define('DOC_STATUS', $doc_status);
define('GOOGLE_MAP_KEY', 'AIzaSyDEHe87jnqea9sCaKftcPcWCJFOYo4WW1U');

//require_once('/home/pida/public_html/include/config.php');

//require_once('./../../include/config.php');
require_once('./../../lib/Cake/Config/config.php');
