...
<?php echo $this->Html->css(array('sweet-alert.css', 'ie9.css', 'toastr.min.css', 'select2.min.css', 'DT_bootstrap.css', 'bootstrap-datetimepicker','star-rating.css'), null, array('inline' => false));
echo $this->Html->script(array('select2.min.js', 'jquery.dataTables.min.js', 'table-data.js', 'sweet-alert.min.js', 'ui-notifications.js', 'bootstrap-datepicker','star-rating.js'), array('inline' => false)); ?>
...
<script type="text/javascript">
	...
	jQuery('.rating-loading').rating({displayOnly: true, step: 0.01});
...
$option_order = array(
    'Rating.rating ASC' => 'Rating Ascending',
    'Rating.rating DESC' => 'Rating Descending',
...
<section id="page-title">
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h1 class="mainTitle pull-left">Review Booking List</h1>
...
<div class="container-fluid container-fullw bg-white">
    ...
    <div class="border-around margin-bottom-15 padding-10">
        <?php echo $this->Form->create('Booking', array(
                'url' => array('controller' => 'reviews', 'action' => 'index', 'admin' => true), 'class' => 'form', 'role' => 'search', 'autocomplete' => 'off')
        ); ?>
	...
	<div class="col-md-4">
        ...
        <div class="col-md-12">
            <?php 
	    echo $this->Html->link('Reset <i class="fa fa-times-circle"></i>', array('controller' => 'reviews','action'=>'reset_filter','admin' => true), array('title' => 'Reset', 'escape' => false, 'class' => 'btn btn-primary btn-wide pull-right'));
    ...
    <?php echo $this->Form->create('PageSize', array(
            'url' => array('controller' => 'reviews', 'action' => 'index', 'admin' => true), 'class' => 'form', 'autocomplete' => 'off', 'id' => 'pageSizeForm')
    ); ?>
        ...
        <div class="col-md-12">
		    ...
		    <th>Type</th>
				...
				<?php
					...
					echo "<input name=\"input-3\" value=\"$rating\" class=\"rating-loading\" data-size=\"xs\">";
				    }else{
					echo '-';
				    }
				?>
			    </td>
			    <td><?php echo $data['Rating']['comment']; ?></td>
			    <td><?php
			    ...
			    <td>
                                <div>
                                    ...
                                    echo $this->Html->link('<i class="fa fa-eye"></i>',
                                        array('plugin' => false, 'controller' => 'reviews', 'action' => 'view', 'id' => base64_encode($data['Rating']['id']), 'admin' => true),
                    ...
                    ?>
                    <tr>
                        <td colspan="10" class="text-center">Reviews Not Available !</td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
