...
/*        jQuery('#reset_button').click(function(){
            ...
            jQuery('#order_by').val('FeedbackTypeLocale.name ASC');
        }); */
...
$option_order = array(
    ...
    'FeedbackType.status ASC, FeedbackTypeLocale.name ASC' => 'Status Ascending',
    'FeedbackType.status DESC, FeedbackTypeLocale.name ASC' => 'Status Descending',
    'FeedbackType.created ASC' => 'Created On Ascending',
    'FeedbackType.created DESC' => 'Created On Descending',
);
...
<section id="page-title">
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <h1 class="mainTitle pull-left">Feedback Type List</h1>
            <div class="row pull-right">
                <?php
                echo $this->Html->link('Add Feedback Type <i class="fa fa-plus"></i>',
                    array('plugin' => false, 'controller' => 'feedback_types', 'action' => 'add_edit', 'admin' => true),
...
<div class="container-fluid container-fullw bg-white">
    ...
    <div class="border-around margin-bottom-15 padding-10">
        <?php echo $this->Form->create('FeedbackType', array(
                'url' => array('controller' => 'feedback_types', 'action' => 'index', 'admin' => true), 'class' => 'form', 'role' => 'search', 'autocomplete' => 'off')
        ); ?>
        ...
        <div class="col-md-12">
            <?php
            echo $this->Html->link('Reset <i class="fa fa-times-circle"></i>', array('controller' => 'feedback_types','action'=>'reset_filter','admin' => true), array('title' => 'Reset', 'escape' => false, 'class' => 'btn btn-primary btn-wide pull-right'));
    ...
    <?php echo $this->Form->create('PageSize', array(
            'url' => array('controller' => 'feedback_types', 'action' => 'index', 'admin' => true), 'class' => 'form', 'autocomplete' => 'off', 'id' => 'pageSizeForm')
    ); ?>
            ...
            <table class="table table-striped table-bordered table-hover table-full-width">
                ...
                <?php if (!empty($result_data)) { ?>
                    <?php foreach ($result_data as $data) { ?>
                        <tr>
                            <td><?php echo ucfirst($data['FeedbackTypeLocale']['name']); ?></td>
                            <td><?php echo $languages[$data['FeedbackTypeLocale']['lang_code']]; ?></td>
                            <td> <?php
                                if ($data['FeedbackType']['status'] == 'A') {
                            ...
                            <td>
                                <?php echo date(DATETIME_FORMAT, $data['FeedbackType']['created']); ?>
                            </td>
                            <td>
                                <div>
                                    <?php
                                    if ($data['FeedbackType']['status'] == 'A') {
                                        echo $this->Html->link('<i class="fa fa-check-circle"></i>', array('controller' => 'feedback_types', 'action' => 'status', base64_encode($data['FeedbackType']['id']), 'I', 'admin' => true), array('title' => 'Click here to inactive', 'escape' => false, 'class' => 'btn btn-transparent btn-xs'));
                                    } else {
                                        echo $this->Html->link('<i class="fa fa-times-circle"></i>', array('controller' => 'feedback_types', 'action' => 'status', base64_encode($data['FeedbackType']['id']), 'A', 'admin' => true), array('title' => 'Click here to active', 'escape' => false, 'class' => 'btn btn-transparent btn-xs'));
                                    }

                                    echo $this->Html->link('<i class="fa fa-pencil"></i>',
                                        array('plugin' => false, 'controller' => 'feedback_types', 'action' => 'add_edit', 'id' => base64_encode($data['FeedbackType']['id']), 'admin' => true),
                                        array('class' => 'btn btn-transparent btn-xs', 'title' => 'Click here to edit Feedback Type', 'escape' => false)
                                    );
                                     ?>
                                </div>
                            </td>
                    ...
                    ?>
                    <tr>
                        <td colspan="5" class="text-center">Feedback Type Not Available !</td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
