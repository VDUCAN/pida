    ...
    <div class="sidebar-container perfect-scrollbar">
        <nav>
            ...
            <ul class="main-navigation-menu">
                ...
                <li class="<?php echo (isset($tab_open) && $tab_open == 'delivery_types') ? 'active open' : '' ?>">
                    <a href="<?php echo $this->Html->url(array('plugin' => false,'controller' => 'delivery_types','action' => 'index', 'admin' => true)); ?>">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title">Delivery Types Management</span>
                            </div>
                        </div>
                    </a>
                </li>

                <li class="<?php echo (isset($tab_open) && $tab_open == 'feedback_types') ? 'active open' : '' ?>">
                    <a href="<?php echo $this->Html->url(array('plugin' => false,'controller' => 'feedback_types','action' => 'index', 'admin' => true)); ?>">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title">Feedback Types Management</span>
                            </div>
                        </div>
                    </a>
                </li>
