<div class="sidebar app-aside" id="sidebar">
	...
	<!--	<li class="<?php echo (isset($tab_open) && $tab_open == 'payments') ? 'active open' : '' ?>">
		...
		<li class="<?php echo (isset($tab_open) && $tab_open == 'reviews') ? 'active open' : '' ?>">
		  ...
		  <li class="slide_class <?php echo (isset($tab_open) && in_array($tab_open, array('drivers', 'customers'))) ? 'active open' : '' ?>">
                    <a href="javascript:void(0)">
                        <div class="item-content">
                            <div class="item-media">
                    ...
                    <ul class="sub-menu" style="<?php echo (isset($tab_open) && in_array($tab_open, array('drivers', 'customers'))) ? '' : 'display: none;' ?>">
