        ...
        <tr>
          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="left" valign="middle" style=" font-size:18px; text-transform:uppercase; text-align:right; font-weight:bold;">Hello,
                  <?php echo $name; ?> </td>
        ...
        <tr>
          <td align="left" valign="top" style="font-size:12px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  <td height="30" colspan=4>Your account has been approved. Below are you account credentials</td>
              </tr>              
              
              <tr>
                <td width="15" height="30">Email</td>
                 <td width="125" height="30" style="font-weight:bold;"><?php echo $email; ?></td>
                <td width="30" height="30">Password</td>
                <td width="125" height="30" style="font-weight:bold;"><?php echo $register_password; ?></td>
              </tr>              
            </table>
		  </td>
        </tr>
