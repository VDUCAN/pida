        ...
        <div class="row">
            <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                <div class="logo margin-top-30" style="text-align:center;">
                    <?php echo $this->Html->image('/img/logo.png', array('border' => 0, 'alt' => 'Pida App', 'title' => 'Pida App', 'width' => '100')); ?>
                </div>
                <!-- start: LOGIN BOX -->
                <div class="box-login">
                    ...
                    <!-- start: COPYRIGHT -->
                    <div class="copyright">
                        &copy; <span class="current-year"></span><span class="text-bold text-uppercase">Pida App</span>. <span>All rights reserved</span>
                    </div>
                    <!-- end: COPYRIGHT -->
                </div>
                <!-- end: LOGIN BOX -->
