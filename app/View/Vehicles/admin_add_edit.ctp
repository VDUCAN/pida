                        ...
                        <div class="form-group">
                            ...
                            if('' != $doc && file_exists(VEHICLE_DOC_PATH . $doc)){ ?>
                                <label class="control-label">
                                    ...
                                    <a class="drive-image-link" href="<?php echo VEHICLE_DOC_URL . $doc; ?>" data-lightbox="driver-doc" data-title="Registration Docoument"><img class="driver-image" src="<?php echo VEHICLE_DOC_URL . $doc; ?>" alt="Registration Docoument" /></a>
                ...
                <?php if('' != $id){ ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            if('' != $doc1 && file_exists(VEHICLE_DOC_PATH . $doc1)){ ?>
                                <label class="control-label">
                                    <?php echo $this->Form->input('recent_insurance_policy_doc_file', array('type' => 'hidden', 'required' => false, 'value' => $doc1)); ?>

                                    <a class="drive-image-link" href="<?php echo VEHICLE_DOC_URL . $doc1; ?>" data-lightbox="driver-doc" data-title="Insurance Policy Docoument"><img class="driver-image" src="<?php echo VEHICLE_DOC_URL . $doc1; ?>" alt="Insurance Policy Docoument" /></a>
