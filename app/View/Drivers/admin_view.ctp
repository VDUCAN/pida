...
$option_bank_status = array('C' => 'Checking', 'S' => 'Saving');
 ?>
    ...
    <div class="row">
		...
		<div class="col-md-6">
			...
			if('' != $doc && file_exists(DRIVER_DOC_PATH . $doc)){ ?>
			    <label class="control-label">
                    <a class="driver-image-link" href="<?php echo DRIVER_DOC_URL . $doc; ?>" data-lightbox="driver-doc" data-title="Driving License Document"><img class="driver-image" src="<?php echo DRIVER_DOC_URL . $doc; ?>" alt="Driving License Document" /></a>
				<?php /* ?>
		...
		<div class="col-md-6">
			...
			if('' != $photo && file_exists(USER_PHOTO_PATH . $photo)){ ?>
			    <label class="control-label">
                    <a class="driver-image-link" href="<?php echo USER_PHOTO_URL . $photo; ?>" data-lightbox="driver-doc" data-title="Driver Photo"><img class="driver-image" src="<?php echo USER_PHOTO_URL . $photo; ?>" alt="Driver Photo" /></a>      
			    </label>
			<?php }else{
			    echo 'N/A';
			} ?>
...
<!-- start: PAGE TITLE -->
 <section id="page-title">
     <div class="row">
     <div class="col-sm-8">
         <h1 class="mainTitle"> Bank Account Details  </h1>
     </div>
     </div>
 </section>
...
<div class="container-fluid container-fullw bg-white">
    ...
    <div class="row">
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label text-bold">Account Type :</label>
                            <?php
                            if(!empty($this->data['BankDetail']['account_type'])){
                                echo $option_bank_status[$this->data['BankDetail']['account_type']];
                            }else{
                                echo 'N/A';
                            }
                            ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label text-bold">Router No :</label>
                        <?php
                            echo !empty($this->data['BankDetail']['router_no']) ? $this->data['BankDetail']['router_no'] : 'N/A';
                        ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label text-bold">Account No :</label>
                    <?php
                        echo !empty($this->data['BankDetail']['account_no']) ? $this->data['BankDetail']['account_no'] : 'N/A';
                    ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label text-bold">Sub Merchant Id :</label>
                        <?php 
                            echo !empty($this->data['BankDetail']['sub_merchant_id']) ? $this->data['BankDetail']['sub_merchant_id'] : 'N/A';
                        ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label text-bold">Created On :</label>
                        <?php
                        if(!empty($this->data['BankDetail']['created'])){
                            echo date(DATETIME_FORMAT, strtotime($this->data['BankDetail']['created']));  
                        }else{
                            echo 'N/A';
                        }
                        ?>
    ...
    <div class="row">
		...
		<div class="col-md-6">
			...
			if('' != $doc && file_exists(VEHICLE_DOC_PATH . $doc)){ ?>
			    <label class="control-label">
                    <a class="driver-image-link" href="<?php echo VEHICLE_DOC_URL . $doc; ?>" data-lightbox="driver-doc" data-title="Insurance policy doc"><img class="driver-image" src="<?php echo VEHICLE_DOC_URL . $doc; ?>" alt="Insurance policy doc" /></a>
				<?php /* ?>
			...
			<?php }else{
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label text-bold">Vehicle registration doc  :</label>
                    </div>
                </div>
		...
		<div class="col-md-6">
			...
			if('' != $doc && file_exists(VEHICLE_DOC_PATH . $doc)){ ?>
			    <label class="control-label">
                    <a class="driver-image-link" href="<?php echo VEHICLE_DOC_URL . $doc; ?>" data-lightbox="driver-doc" data-title="Vehicle registration doc"><img class="driver-image" src="<?php echo VEHICLE_DOC_URL . $doc; ?>" alt="Vehicle registration doc" /></a>
				<?php /* ?>
				<a href="<?php echo VEHICLE_DOC_URL . $doc; ?> " target="_blank" ><?php echo $doc;?></a>
				<?php */ ?>
			    </label>
